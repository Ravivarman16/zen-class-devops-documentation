...
![STS](https://github.com/Ravivarman16/images/blob/main/IAM/sts.webp)
...
![MFA](https://github.com/Ravivarman16/images/blob/main/IAM/Multi-Factor-Authentication-MFA.jpg) 
...
+ Then name the IAM User:

![naming](https://github.com/Ravivarman16/images/blob/main/IAM/NAMING_USER.png)

+ Then selecting the access via **management console option:** under that select option: **I want to create an IAM User.**

![management_console](https://github.com/Ravivarman16/images/blob/main/IAM/management_console.png)

+ Then under **console password**, there will two options select according to your preferences:
...
+  Then under **set permissions**, there will be three options:
...
+ I had selected third option on above, attaching the policy as per my preferences. You can add the policy according to your preferences or requirement. **click next.**

![attaching_policies](https://github.com/Ravivarman16/images/blob/main/IAM/attaching_permissions.png)

+ Then just review the configurations that you configured, if everything is correct, click 

![review](https://github.com/Ravivarman16/images/blob/main/IAM/review%20%26%20create.png)

![create_user](https://github.com/Ravivarman16/images/blob/main/IAM/create_user.png)

+ We can able to see the IAM user is created, click view user:

![output_usesr](https://github.com/Ravivarman16/images/blob/main/IAM/OUTPUT_USER.png)

+ We could be able to see the Created IAM User details:
