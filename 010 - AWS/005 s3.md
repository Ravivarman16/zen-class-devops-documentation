...
### **First select the newly created bucket:**
...
### **Then on the right side we can see upload option, click that one:**
...
### **Then on right side, we can add files option, click that one to add files:**
...
### **Then select the files & upload the files to the S3 bucket:**
...
### **Then we can see files has been uploaded from your machine to S3:**
...
### **Then under properties, we can specify the storage classes, but here I am selecting default Storage class: Amazon S3 Standard.**
...
### **Then at last we can see the upload option, click that one to upload:**
...
### **We can see the files has been uploaded successfully:**
...
### **Then select the object that you want to share:**
...
### **Then on the right top side we can able to see object actions, click that one:**
...
### **On that we could able to see share with a presigned URL option, click that one:**
...
### **Then select the option either you want to share for hour or for minutes, according to that enter a value. Click Create presigned URL:**
...
### **We can able to see the URL has been created successfully: Just copy the link & share to the person whomever you want to share.**
